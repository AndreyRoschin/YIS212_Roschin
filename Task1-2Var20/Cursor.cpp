...
void Cursor::set_correct_coordinates(const unsigned int& coordinates_x, const unsigned int& coordinates_y)
{
...
void Cursor::set_correct_cursor_size(const unsigned int& cursor_size)
{
